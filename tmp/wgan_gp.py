...
os.makedirs("img/wgan_gp/", exist_ok=True)
...
def compute_gradient_penalty(D, real_samples, fake_samples):
    ...
    # print(d_interpolates.shape)  # torch.Size([160, 1])
...
for epoch in range(opt.n_epochs):
    for i, (imgs, _) in enumerate(dataloader):
        ...
        # print(z.shape)
        z = torch.randn(imgs.shape[0], opt.latent_dim, device='cuda')
        # print(z.shape)
        ...
        # print(real_validity.shape)  # torch.Size([160, 1])
        # Fake images
        ...
        if i % opt.n_critic == 0:
            ...
            if batches_done % opt.sample_interval == 0:
                save_image(fake_imgs.data[:25], "img/wgan_gp/%d.png" %
